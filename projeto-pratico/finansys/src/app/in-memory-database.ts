...
export class InMemoryDatabase implements InMemoryDbService{
    createDb(){
        ...
        const entries: Entry[] = [
            { id: 2, name: 'Suplementos', categoryId: categories[1].id, category: categories[1], paid: false, date: "14/10/2018", amount: "15,00", type: "expense", description: "Qualquer descrição para essa despesa" }  as Entry,
